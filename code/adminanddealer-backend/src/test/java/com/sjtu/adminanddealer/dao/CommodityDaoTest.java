...
public class CommodityDaoTest {
     ...
     *             (20, 'image/commodityDefaultPic.jpg', 'commodity information 111', 100, true, 12, 50)
     *             (21, 'image/commodityDefaultPic.jpg', 'commodity_info_2', 300, true, 30, 300)
     *             (23, 'image/commodity1.jpg', 'information3', 200, false, 234, 0)
     * in table:
    ...
    public void testGetAllCommodityByStore() throws Exception {
        List<Commodity> commodityList = commodityDao.getAllCommodityByStore(23L);
        ...
        Assert.assertEquals(commodityList.get(0).getCommodityId().longValue(), 20L);
        Assert.assertEquals(commodityList.get(1).getCommodityId().longValue(), 21L);
    }

    @Test
    public void testGetCommodityById() throws Exception {
        Commodity commodity = commodityDao.getCommodityById(23L);
        Assert.assertNotNull(commodity);
        Assert.assertEquals(commodity.getCommodityId().longValue(), 23);
