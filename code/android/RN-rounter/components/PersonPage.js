...
export default class PersonPage extends Component{
  ...
  handler1(){
    var responseData;
    axios.get('http://10.166.162.114:8080/user/modify',{params:{userId:1,userName:this.state.username,password:'123456',
    address:this.state.address,phone:this.state.phone,gender:this.state.sex,regDate:'01/01/2019',latitude:21,longitude:22.3}})
