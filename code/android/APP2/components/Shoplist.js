...
import { createAppContainer, createStackNavigator, StackActions, NavigationActions,DeviceEventEmitter } from 'react-navigation';
...
export default class ShopList extends Component{
    ...
    componentWillMount(){
      axios.get("http://192.168.1.59:9000/stores").then((response)=>{
        list = response.data;
