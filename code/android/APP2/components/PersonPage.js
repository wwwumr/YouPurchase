...
export default class PersonPage extends Component{
  constructor(props){
    ...
    this.state={
      ...
      detail:{},
      image: null,
      uri:"http://192.168.1.59:8085//image/getPhoto?userId="+this.props.userId+"&v=0"
    }
  }
  ...
  handler1(){
    ...
    axios.post('http://192.168.1.59:8080/user/modify',/*params:{userId:responseData.userId,userName:this.state.username,password:"123456",
    ...
    .then((response)=> {
      ...
      if(responsedata.status==200){
          this.setState({detail:responsedata,uri:"http://192.168.1.59:8085//image/getPhoto?userId="+this.props.userId+"&v=0"+Math.random(),
          isVisible:false})
        }
      else
      Alert.alert("操作失败")
  ...
  pickSingleBase64(cropit) {
    var uri = "http://192.168.1.59:8085/image/getPhoto?userId="+this.props.userId+"&v="+Math.random();
    ImagePicker.openPicker({
      ...
      axios.post("http://192.168.1.59:8085/user/uploadPhoto",{userId:this.props.userId,photoImage:`data:${image.mime};base64,`+ image.data}).then((response)=>{
