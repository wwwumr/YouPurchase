...
export default class OrderOk2 extends Component{
    ...
    componentWillMount(){
        ...
        var url=config.url+'order/idUser?orderInfoId='+orderInfoId+'&userId='+userId;
          ...
          />
                ...
                >
                 ...
                 <View
                  ...
                  >
                    <ListItem 
                      leftIcon={<Image source={{uri:config.url2+this.state.storePic}} style={{width:30,height:30}}/>}
