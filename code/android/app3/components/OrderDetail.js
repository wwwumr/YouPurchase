...
export default class OrderDetail extends Component{
    ...
    submit(){
      ...
      axios.post('http://192.168.1.19:8080/grade/add',{createDate:createData,content:content,orderInfoId:orderInfoId,score:score,userId:userId,storeId:storeId})
      .then((response)=> {
                ...
                <View
                 ...
                 <View 
                    ...
                    style={{backgroundColor:"#ffffff",marginLeft:10,marginRight:10}}>
                     ...
                     <View style={{marginLeft:50}}><Button onPress={()=>{this.props.navigation.navigate('Map')}} type="outline" title="详情"/></View>
                     </View>
                         </View>
                 </View>
                 <View
