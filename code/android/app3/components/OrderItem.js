...
export default class OrderItem extends Component{
  ...
  <View style={{marginTop:20,marginBottom:10,backgroundColor:"#ffffff"}}>
    ...
    <ListItem
    rightIcon={<View style={{flexDirection:"row"}}><View style={{marginRight:10}}><Button title="详情" type="outline" onPress={this.handler3.bind(this)}/></View><Button title="评价" type="outline" onPress={this.handler.bind(this)}/></View>}/>
    </View>
    <Overlay
