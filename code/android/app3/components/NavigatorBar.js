  ...
  render() {
    ...
    return (
      <View style={styles.container}>
         <TabNavigator>
            {this.tabNavigatorItems('shouye',"首页",require('../images/shouye.jpg'),require("../images/shouye1.jpg"),'#ffe09a',"",<Shoplist userId={id}navigation={this.props.navigation}/>)}
            {this.tabNavigatorItems('cart',"购物车",require('../images/cart1.jpg'),require("../images/cart.jpg"),'#65bb74',"",<ShopCart1/>)}
            {this.tabNavigatorItems('dingdan',"订单",require('../images/dingdan.jpg'),require("../images/dingdan1.jpg"),'#6ebef3',"",<Orderlist userId={id}navigation={this.props.navigation}/>)}
