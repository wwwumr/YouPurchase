...
export default class Goodslist extends Component{
 ...
 /*********************************** 
    ...
    ************************************/
    ...
    /**
     * @description 对getclass事件的响应
     * @param  {Integer} commodityClassId
     */
          ...
          <ScrollView style={{marginBottom:100,marginTop:20}}>
              <View>
                  ...
                  <View style={{marginLeft:40,
                      ...
                      flexDirection:'row'}}
                  >
                  <Text style={{fontSize:15}}>手机 {info.contact}
                  </Text>
                  <Text style={{fontSize:15,marginLeft:30}}>营业 09:00-21:00
                  </Text>
                  </View>
