                ...
                <ScrollView style={{marginBottom:100,marginTop:20}}>
                    <View>
                        <View style={{alignItems:"center"}}>
                            <Image source={require('../images/dianpu.jpg')}
                                style={{width:80,height:80}}
                            />
                            <Text  style={{textAlign:'center',
                                fontSize:25,
                                color:'#000000'}}>{storeName}
                            </Text>
                        </View>
                        <Text  style={{textAlign:'center',
                            fontSize:20,
                ...
                return(
                    <View >
                        <ListItem 
                            ...
                            rightTitle={<Text style={{fontSize:13}}>
                                {item.createDate.substring(0,10)}
                            </Text>}
                            rightSubtitle={<Text style={{fontSize:13}}>
                                {item.content}
                            </Text>}
                            leftIcon={<Image source={require('../images/touxiang1.jpg')} 
