...
export default class ShopItem extends Component{
    ...
    handler3(){
        this.props.navigation.navigate('OrderDetail',{orderStatus:this.props.orderStatus,
            leftIcon:this.props.leftIcon,
            storeName:this.props.storeName,
            orderItemList:this.props.orderItemList,
            judged:this.props.judged,
            totalPrice:this.props.totalPrice,
            tarPeople:this.props.tarPeople,
            tarPhone:this.props.tarPhone,
            tarAddress:this.props.tarAddress,
            createData:this.props.time,
    ...
    render(){
        ...
        return(
            ...
            <View style={{marginLeft:10,marginRight:10}}>
                <ListItem
                    leftIcon={<Image source={require("../images/dianpu.jpg")}  
                    ...
                    subtitle={<View style={{flexDirection:'row'}}>
                        ...
                        <Text style={{fontSize:13}}>    月销量{this.props.sales}</Text>
                        <Text style={{fontSize:13}}>    距离{this.props.distance}km</Text>
                    </View>}
                />
                ...
                <ListItem
                    ...
                    rightTitle={<View style={{height:10,width:100}}>
                        <Button onPress={()=>{
